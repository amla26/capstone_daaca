...
// import capstoneAnt.node;
 ...
 {	 
   ...
   /* Initialize initial energy and routing table for each node */
         ...
         System.out.println("-----------------------------------------------");
         System.out.println("Initialisation of routing table is completed");
...
System.out.println("-----------------------------------------------");
	 ...
	 {	System.out.println();	
		 System.out.println("--------------------------------------------");
		 System.out.println("Entering the round to update phermones");
	 ...
	 System.out.println("Node energies after "+no_transmit+" rounds  in milijoules");
	 System.out.println();
