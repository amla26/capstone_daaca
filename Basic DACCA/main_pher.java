...
// import capstoneAnt.node;
 ...
 {	 
	...
	String var = inp1.nextLine();
		number_vertices=Integer.valueOf(var);
...
inp2=new Scanner(System.in);
		...
		// header[recent++]=next_hop;
		 ...
		 {
			 System.out.println("Entering round to update");
	 ...
	 while(track[l]!=100)
	 {
		 System.out.println(track[l]+"->");
		 l++;
	 }
	for(int k=0;k<31;k++)
	{
		System.out.println("energy of node"+n[k]+" is "+n[k].E_curr);
